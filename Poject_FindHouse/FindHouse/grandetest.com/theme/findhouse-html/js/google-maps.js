    ...
    $(".map-canvas").each(function () {
      ...
      var styles = [
        ...
        },
        {
          featureType: "water",
          elementType: "all",
          stylers: [{ color: "#ffe807" }, { visibility: "on" }],
        },
      ];
      ...
      if ($(this).hasClass("skin2")) {
        ...
        var styles = [
          ...
          },
          {
            featureType: "water",
            elementType: "all",
            stylers: [{ color: "blue" }, { visibility: "on" }],
          },
        ];
      }
      if ($(this).hasClass("skin3")) {
        ...
        var styles = [
          ...
          },
          {
            featureType: "water",
            elementType: "all",
            stylers: [{ color: "#13a0b2" }, { visibility: "on" }],
          },
        ];
      }
      if ($(this).hasClass("skin4")) {
        ...
        var styles = [
          ...
          },
          {
            featureType: "water",
            elementType: "all",
            stylers: [{ color: "#44e2ff" }, { visibility: "on" }],
          },
        ];
      }
      ...
      if (iconPath) {
        ...
        map.addMarker({
          ...
          infoWindow: {
            content:
              '<img src="images/property/fp2.jpg" alt="fp2.jpg"/> <h5>Villa</h5> <h4>Gorgeous Villa Bay View</h4> <p>1421 San Pedro St, Los Angeles, CA</p> <p><span>Beds: 4</span> <span>Baths: 2</span> <span>Sq Ft: 5280</span></p>',
          },
        });
        map.addMarker({
          icon: iconPath,
          ...
          infoWindow: {
            content:
              '<img src="images/property/fp3.jpg" alt="fp3.jpg"/> <h5>Single Family Home</h5> <h4>Luxury Family Home</h4> <p>1421 San Pedro St, Los Angeles, CA</p> <p><span>Beds: 4</span> <span>Baths: 2</span> <span>Sq Ft: 5280</span></p>',
          },
        });
        map.addMarker({
          icon: iconPath,
